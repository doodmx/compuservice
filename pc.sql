...
--
-- Servidor: localhost
-- Tiempo de generación: 27-08-2020 a las 14:48:27
...
--
-- Base de datos: `pc_service`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_access`
--
...
--
-- Volcado de datos para la tabla `pc_access`
--

INSERT INTO `pc_access` (`ID`, `user`, `ip`, `navegador`, `os`, `code`, `fecha`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_api_version`
--

CREATE TABLE `pc_api_version` (
  `ID` int(9) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_api_version`
--

INSERT INTO `pc_api_version` (`ID`, `nom`, `vence`, `ultimate`, `status`, `des_ver`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_blog`
--
...
--
-- Volcado de datos para la tabla `pc_blog`
--

INSERT INTO `pc_blog` (`ID`, `cover`, `titulo`, `descripcion`, `contenido`, `tag`, `autor`, `fmod`, `fecha`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_blog_coment`
--

CREATE TABLE `pc_blog_coment` (
...
--
-- Volcado de datos para la tabla `pc_blog_coment`
--

INSERT INTO `pc_blog_coment` (`ID`, `ip`, `nombre`, `email`, `comentario`, `id_b`, `fecha`, `visible`) VALUES
(1, '127.0.0.1', 'Miguel Hernadez', 'mherco@hotmail.com', 'Mensaje de prueba de un comentario.', 1, '2019-07-06 18:14:37', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_clientes`
--
...
--
-- Volcado de datos para la tabla `pc_clientes`
--

INSERT INTO `pc_clientes` (`ID_cli`, `nombre`, `empresa`, `domicilio`, `tel_ofi`, `email`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_comp`
--

CREATE TABLE `pc_comp` (
  `ID` int(1) UNSIGNED NOT NULL,
  `page` varchar(50) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `pc_comp`
--

INSERT INTO `pc_comp` (`ID`, `page`) VALUES
(1, 'usuarios/login.php');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_config`
--
...
--
-- Volcado de datos para la tabla `pc_config`
--

INSERT INTO `pc_config` (`ID`, `logo`, `page_name`, `title`, `dominio`, `path_root`, `page_url`, `keyword`, `description`, `metas`, `g_analytics`, `tel`, `phone`, `wapp`, `webMail`, `contactMail`, `mode`, `chartset`, `dboard`, `dboard2`, `direc`, `CoR`, `CoE`, `BCC`, `CoP`, `fb`, `tw`, `gp`, `lk`, `yt`, `ins`, `wv`, `licencia`, `version`) VALUES
(1, 'logo.min.png', 'Compu-services', 'Venta y Reparaci&oacute;n de computadoras, celulares y drones', 'http://compuservices.mx', '', 'http://compuservices.mx', 'venta, reparaci&oacute;n, mantenimiento, computadoras, celulares, smartphones, drones', 'Venta y Reparaci&oacute;n de computadoras, celulares y drones', '<!--Responsive Meta-->\r\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1, maximum-scale=1\">\r\n<!-- META-TAGS generadas por http://metatags.miarroba.es -->\r\n<META NAME=\"DC.Language\" SCHEME=\"RFC1766\" CONTENT=\"Spanish\">\r\n<META NAME=\"AUTHOR\" CONTENT=\"Guillermo Jimenez\">\r\n<META NAME=\"REPLY-TO\" CONTENT=\"multiportal@outlook.com\">\r\n<LINK REV=\"made\" href=\"mailto:multiportal@outlook.com\">\r\n', '<!--Google Analytics-->', '971 58 568 2912', '971 58 568 2912', '+971 58 568 2912', '', '', 'page', 'iso-8859-1', 'dashboard', 'AdminLTE', 'Centro, Santiago de Querétaro, México', 'multiportal@outlook.com', 'phponix@webcindario.com', '', 'memojl08@gmail.com', '', '', '', '', '', '', '', 'cms-px31q2hponix31q2x.admx31q2in458x31q2x.202x31q24.05.x31q212.01x31q2.2.6.x31q26x31q2', '01.2.8.0');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_contacto`
--

CREATE TABLE `pc_contacto` (
  `ID` int(9) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_contacto`
--

INSERT INTO `pc_contacto` (`ID`, `ip`, `nombre`, `email`, `para`, `de`, `tel`, `titulo`, `asunto`, `msj`, `fecha`, `cat_list`, `seccion`, `tabla`, `adjuntos`, `visto`, `status`, `ID_login`, `ID_user`, `visible`) VALUES
...
--
-- Volcado de datos para la tabla `pc_contacto_forms`
--

INSERT INTO `pc_contacto_forms` (`ID`, `seccion`, `modulo`, `email`, `bcc`, `CoE`, `CoP`, `usuario`, `url_m`, `fecha`, `activo`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_countries`
--

CREATE TABLE `pc_countries` (
  `id` int(5) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_countries`
--

INSERT INTO `pc_countries` (`id`, `countryCode`, `countryName`, `currencyCode`, `capital`, `continentName`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_css`
--
...
--
-- Estructura de tabla para la tabla `pc_css2`
--

CREATE TABLE `pc_css2` (
...
--
-- Estructura de tabla para la tabla `pc_cursos`
--
...
--
-- Estructura de tabla para la tabla `pc_cursos_coment`
--

CREATE TABLE `pc_cursos_coment` (
  `ID` int(6) UNSIGNED NOT NULL,
  `ip` varchar(18) NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `email` varchar(50) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pc_depa`
--

CREATE TABLE `pc_depa` (
...
--
-- Volcado de datos para la tabla `pc_depa`
--

INSERT INTO `pc_depa` (`ID`, `nombre`, `list_depa`, `puesto`, `nivel`, `icono`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_directorio`
--

CREATE TABLE `pc_directorio` (
  `ID` int(6) UNSIGNED NOT NULL,
  `cover` varchar(100) NOT NULL,
  `nom` varchar(100) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pc_empresa`
--

CREATE TABLE `pc_empresa` (
  `ID` int(11) UNSIGNED NOT NULL,
  `nom` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_empresa`
--

INSERT INTO `pc_empresa` (`ID`, `nom`, `ima`, `contenido`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_galeria`
--

CREATE TABLE `pc_galeria` (
  `ID` int(6) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pc_histo_backupdb`
--

CREATE TABLE `pc_histo_backupdb` (
  `ID` int(9) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pc_home_config`
--

CREATE TABLE `pc_home_config` (
  `ID` int(1) UNSIGNED NOT NULL,
  `titulo` varchar(200) NOT NULL,
  `contenido` text NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_home_config`
--

INSERT INTO `pc_home_config` (`ID`, `titulo`, `contenido`, `selc`, `activo`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_iconos`
--

CREATE TABLE `pc_iconos` (
  `ID` int(6) UNSIGNED NOT NULL,
  `nom` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_iconos`
--

INSERT INTO `pc_iconos` (`ID`, `nom`, `fa_icon`, `icon`, `tipo`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_ipbann`
--

CREATE TABLE `pc_ipbann` (
  `ID` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_ipbann`
--

INSERT INTO `pc_ipbann` (`ID`, `ip`, `bloqueo`, `alta`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_landingpage_seccion`
--

CREATE TABLE `pc_landingpage_seccion` (
  `ID` int(6) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_landingpage_seccion`
--

INSERT INTO `pc_landingpage_seccion` (`ID`, `seccion`, `tit`, `conte`, `visible`) VALUES
(1, 'Nosotros', '', '', '1'),
(2, 'Equipo', '', '', '1'),
(3, 'Servicios', '', '', '1'),
(4, 'Portafolio', '', '', '1'),
...
--
-- Estructura de tabla para la tabla `pc_map_config`
--

CREATE TABLE `pc_map_config` (
  `ID` int(6) UNSIGNED NOT NULL,
  `nom` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_map_config`
--

INSERT INTO `pc_map_config` (`ID`, `nom`, `lat`, `lng`, `zoom`, `cover`, `on_costo`) VALUES
(1, 'Querétaro', '20.5931297', '-100.3920483', '12', 'g_intelmex.png', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_map_ubicacion`
--

CREATE TABLE `pc_map_ubicacion` (
  `ID` int(9) UNSIGNED NOT NULL,
  `nom` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_map_ubicacion`
--

INSERT INTO `pc_map_ubicacion` (`ID`, `nom`, `adres`, `descripcion`, `info`, `precio`, `tel`, `cover`, `nivel`, `rol`, `lat`, `lng`, `alta`, `fmod`, `visible`, `activo`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_menu_admin`
--

CREATE TABLE `pc_menu_admin` (
  `ID` int(6) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_menu_admin`
--

INSERT INTO `pc_menu_admin` (`ID`, `nom_menu`, `icono`, `link`, `nivel`, `ID_menu_adm`, `ID_mod`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_menu_web`
--

CREATE TABLE `pc_menu_web` (
  `ID` int(6) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_menu_web`
--

INSERT INTO `pc_menu_web` (`ID`, `menu`, `url`, `modulo`, `ext`, `ord`, `subm`, `ima_top`, `tit_sec`, `des_sec`, `visible`) VALUES
(1, 'Inicio', 'index.php', 'Home', '', '1', '', 'gris.png', '', '', 1),
(2, 'Nosotros', '#about', 'nosotros', '', '2', '', 'gris.png', '', '', 1),
(3, 'Servicios', '#services', 'portafolio', '', '3', '', 'gris.png', '', '', 1),
(4, 'Ubicacion', '#local', 'blog', '', '4', '', 'gris.png', '', '', 1),
(5, 'Contacto', '#mail', 'contacto', '', '5', '', 'gris.png', '', '', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_mode_page`
--

CREATE TABLE `pc_mode_page` (
  `ID` int(2) UNSIGNED NOT NULL,
  `page_mode` varchar(100) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `pc_mode_page`
--

INSERT INTO `pc_mode_page` (`ID`, `page_mode`) VALUES
(1, 'page'),
(2, 'landingpage'),
(3, 'extranet'),
(4, 'ecommerce'),
...
--
-- Estructura de tabla para la tabla `pc_modulos`
--

CREATE TABLE `pc_modulos` (
  `ID` int(6) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_modulos`
--

INSERT INTO `pc_modulos` (`ID`, `nombre`, `modulo`, `description`, `dashboard`, `nivel`, `home`, `visible`, `activo`, `sname`, `icono`, `link`) VALUES
...
(20, 'Servicios', 'servicios', 'Administrador del modulo servicios', 0, 0, 0, 0, 0, 'false', 'fa-briefcase', 'index.php?mod=servicios');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_noticias`
--

CREATE TABLE `pc_noticias` (
  `ID` int(9) UNSIGNED NOT NULL,
  `cover` varchar(100) NOT NULL,
  `titulo` varchar(100) NOT NULL,
  `descripcion` varchar(200) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_noticias`
--

INSERT INTO `pc_noticias` (`ID`, `cover`, `titulo`, `descripcion`, `contenido`, `tag`, `autor`, `fmod`, `fecha`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_noticias_coment`
--

CREATE TABLE `pc_noticias_coment` (
  `ID` int(6) UNSIGNED NOT NULL,
  `ip` varchar(18) NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `email` varchar(50) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_noticias_coment`
--

INSERT INTO `pc_noticias_coment` (`ID`, `ip`, `nombre`, `email`, `comentario`, `id_b`, `fecha`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_notificacion`
--
...
--
-- Volcado de datos para la tabla `pc_notificacion`
--

INSERT INTO `pc_notificacion` (`ID`, `ID_user`, `ID_user2`, `nombre_envio`, `mensaje`, `visto`, `activo`, `fecha`) VALUES
(1, 1, 1, 'admin', 'Su sistema PHPONIX ha sido actualizado.', 1, 1, '2019-06-27 23:09:38');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_opciones`
--

CREATE TABLE `pc_opciones` (
  `ID` int(6) UNSIGNED NOT NULL,
  `nom` varchar(100) NOT NULL,
  `descripcion` text NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_opciones`
--

INSERT INTO `pc_opciones` (`ID`, `nom`, `descripcion`, `valor`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_pages`
--
...
--
-- Volcado de datos para la tabla `pc_pages`
--

INSERT INTO `pc_pages` (`ID`, `titulo`, `contenido`, `modulo`, `tema`, `ext`, `url`, `fmod`, `alta`, `visible`, `activo`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_portafolio`
--

CREATE TABLE `pc_portafolio` (
  `ID` int(6) UNSIGNED NOT NULL,
  `clave` varchar(100) NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `cover` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_portafolio`
--

INSERT INTO `pc_portafolio` (`ID`, `clave`, `nombre`, `cover`, `foto`, `descripcion`, `precio`, `cate`, `resena`, `url_page`, `imagen1`, `imagen2`, `imagen3`, `imagen4`, `imagen5`, `visible`, `alta`, `fmod`, `user`) VALUES
(1, '', 'Betrec', '1-compressor.jpg', '', 'Descripcion', '0.00', 'Categoria', 'RESEÑA', '', 'be1.jpg', '', '', '', '', 1, '2018-01-07 21:10:52', '', 'admin');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_productos`
--
...
--
-- Estructura de tabla para la tabla `pc_productos_cate`
--

CREATE TABLE `pc_productos_cate` (
...
--
-- Volcado de datos para la tabla `pc_productos_cate`
--

INSERT INTO `pc_productos_cate` (`ID_cate`, `categoria`, `ord`, `cover`, `descripcion`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_productos_coti`
--

CREATE TABLE `pc_productos_coti` (
...
--
-- Estructura de tabla para la tabla `pc_productos_coti_r`
--

CREATE TABLE `pc_productos_coti_r` (
...
--
-- Estructura de tabla para la tabla `pc_productos_files`
--

CREATE TABLE `pc_productos_files` (
...
--
-- Estructura de tabla para la tabla `pc_productos_marcas`
--

CREATE TABLE `pc_productos_marcas` (
...
--
-- Volcado de datos para la tabla `pc_productos_marcas`
--

INSERT INTO `pc_productos_marcas` (`ID_marca`, `logo`, `nombre`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_productos_sub_cate`
--

CREATE TABLE `pc_productos_sub_cate` (
...
--
-- Volcado de datos para la tabla `pc_productos_sub_cate`
--

INSERT INTO `pc_productos_sub_cate` (`ID_sub_cate`, `subcategoria`, `ord`, `ID_cate`, `cover`, `descripcion`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_productos_sub_cate2`
--

CREATE TABLE `pc_productos_sub_cate2` (
...
--
-- Estructura de tabla para la tabla `pc_promociones`
--

CREATE TABLE `pc_promociones` (
  `ID` int(6) UNSIGNED NOT NULL,
  `nom` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_promociones`
--

INSERT INTO `pc_promociones` (`ID`, `nom`, `cate`, `alta`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_registros`
--

CREATE TABLE `pc_registros` (
  `ID` int(9) UNSIGNED NOT NULL,
  `ip` varchar(25) NOT NULL,
  `nombre` varchar(150) NOT NULL,
  `email` varchar(150) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pc_servicios`
--

CREATE TABLE `pc_servicios` (
  `ID` int(6) UNSIGNED NOT NULL,
  `clave` varchar(100) NOT NULL,
  `titulo` varchar(100) NOT NULL,
  `cover` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_servicios`
--

INSERT INTO `pc_servicios` (`ID`, `clave`, `titulo`, `cover`, `descripcion`, `precio`, `cate`, `url_page`, `imagen1`, `imagen2`, `imagen3`, `imagen4`, `imagen5`, `visible`, `alta`, `fmod`, `user`) VALUES
(1, '', 'Horno', 'horno.jpg', '', '0.00', 'Seleccionar Categoria', '', '', '', '', '', '', 1, '', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_signup`
--

CREATE TABLE `pc_signup` (
  `ID` int(9) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_signup`
--

INSERT INTO `pc_signup` (`ID`, `username`, `password`, `email`, `level`, `lastlogin`, `tema`, `nombre`, `apaterno`, `amaterno`, `foto`, `cover`, `tel`, `ext`, `fnac`, `fb`, `tw`, `puesto`, `ndepa`, `depa`, `empresa`, `adress`, `direccion`, `mpio`, `edo`, `pais`, `genero`, `exp`, `likes`, `filtro`, `zona`, `alta`, `actualizacion`, `page`, `nivel_oper`, `rol`, `codigo`, `intentos`, `activo`) VALUES
(1, 'admin', 'c64f923f7f476f0b78716079452e7bdec4b2c016', 'multiportal@outlook.com', '-1', '2020-08-24 09:45:25', 'default', 'Guillermo', 'Jimenez', 'Lopez', 'sinfoto.png', '', '4421944950', 1, '0000-00-00', '', '', 'Programador', 0, '', 'Multiportal', '', '', '', '', '', 'M', '', 0, '0', '', '', 'admin2019xadmin79', '', 0, 0, '944950', '0', 1),
...
--
-- Estructura de tabla para la tabla `pc_slider`
--

CREATE TABLE `pc_slider` (
  `ID` int(6) UNSIGNED NOT NULL,
  `ima` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_slider`
--

INSERT INTO `pc_slider` (`ID`, `ima`, `tit1`, `tit2`, `btn_nom`, `url`, `tema_slider`, `visible`) VALUES
(1, 'home.jpg', 'Slider1', '', 'Boton', '', 'default', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_tareas`
--

CREATE TABLE `pc_tareas` (
  `ID` int(11) UNSIGNED NOT NULL,
  `nom` varchar(100) NOT NULL,
  `descripcion` varchar(250) NOT NULL,
  `visible` tinyint(1) NOT NULL
...
--
-- Volcado de datos para la tabla `pc_tareas`
--

INSERT INTO `pc_tareas` (`ID`, `nom`, `descripcion`, `visible`) VALUES
(1, 'Vcard', 'Nueva tarea', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pc_temas`
--

CREATE TABLE `pc_temas` (
...
--
-- Volcado de datos para la tabla `pc_temas`
--

INSERT INTO `pc_temas` (`ID`, `tema`, `subtema`, `selec`, `nivel`) VALUES
(1, 'default', '', 0, '0'),
(5, 'pc', '', 1, '0');
...
--
-- Estructura de tabla para la tabla `pc_testimonios`
--

CREATE TABLE `pc_testimonios` (
  `ID` int(9) UNSIGNED NOT NULL,
  `cover` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pc_testimonios`
--

INSERT INTO `pc_testimonios` (`ID`, `cover`, `pro`, `comentario`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pc_visitas`
--

CREATE TABLE `pc_visitas` (
  `ID` int(9) UNSIGNED NOT NULL,
...
--
-- Indices de la tabla `pc_access`
--
ALTER TABLE `pc_access`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_api_version`
--
ALTER TABLE `pc_api_version`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_blog`
--
ALTER TABLE `pc_blog`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_blog_coment`
--
ALTER TABLE `pc_blog_coment`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_clientes`
--
ALTER TABLE `pc_clientes`
  ADD PRIMARY KEY (`ID_cli`);

--
-- Indices de la tabla `pc_comp`
--
ALTER TABLE `pc_comp`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_config`
--
ALTER TABLE `pc_config`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_contacto`
--
ALTER TABLE `pc_contacto`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_contacto_forms`
--
ALTER TABLE `pc_contacto_forms`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_countries`
--
ALTER TABLE `pc_countries`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pc_css`
--
ALTER TABLE `pc_css`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_css2`
--
ALTER TABLE `pc_css2`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_cursos`
--
ALTER TABLE `pc_cursos`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_cursos_coment`
--
ALTER TABLE `pc_cursos_coment`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_depa`
--
ALTER TABLE `pc_depa`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_directorio`
--
ALTER TABLE `pc_directorio`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_empresa`
--
ALTER TABLE `pc_empresa`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_galeria`
--
ALTER TABLE `pc_galeria`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_histo_backupdb`
--
ALTER TABLE `pc_histo_backupdb`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_home_config`
--
ALTER TABLE `pc_home_config`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_iconos`
--
ALTER TABLE `pc_iconos`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_ipbann`
--
ALTER TABLE `pc_ipbann`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_landingpage_seccion`
--
ALTER TABLE `pc_landingpage_seccion`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_map_config`
--
ALTER TABLE `pc_map_config`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_map_ubicacion`
--
ALTER TABLE `pc_map_ubicacion`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_menu_admin`
--
ALTER TABLE `pc_menu_admin`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_menu_web`
--
ALTER TABLE `pc_menu_web`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_mode_page`
--
ALTER TABLE `pc_mode_page`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_modulos`
--
ALTER TABLE `pc_modulos`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_noticias`
--
ALTER TABLE `pc_noticias`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_noticias_coment`
--
ALTER TABLE `pc_noticias_coment`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_notificacion`
--
ALTER TABLE `pc_notificacion`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_opciones`
--
ALTER TABLE `pc_opciones`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_pages`
--
ALTER TABLE `pc_pages`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_portafolio`
--
ALTER TABLE `pc_portafolio`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_productos`
--
ALTER TABLE `pc_productos`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_productos_cate`
--
ALTER TABLE `pc_productos_cate`
  ADD PRIMARY KEY (`ID_cate`);

--
-- Indices de la tabla `pc_productos_coti`
--
ALTER TABLE `pc_productos_coti`
  ADD PRIMARY KEY (`ID_coti`);

--
-- Indices de la tabla `pc_productos_coti_r`
--
ALTER TABLE `pc_productos_coti_r`
  ADD PRIMARY KEY (`ID_reg`);

--
-- Indices de la tabla `pc_productos_files`
--
ALTER TABLE `pc_productos_files`
  ADD PRIMARY KEY (`ID_pfile`);

--
-- Indices de la tabla `pc_productos_marcas`
--
ALTER TABLE `pc_productos_marcas`
  ADD PRIMARY KEY (`ID_marca`);

--
-- Indices de la tabla `pc_productos_sub_cate`
--
ALTER TABLE `pc_productos_sub_cate`
  ADD PRIMARY KEY (`ID_sub_cate`);

--
-- Indices de la tabla `pc_productos_sub_cate2`
--
ALTER TABLE `pc_productos_sub_cate2`
  ADD PRIMARY KEY (`ID_sub_cate2`);

--
-- Indices de la tabla `pc_promociones`
--
ALTER TABLE `pc_promociones`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_registros`
--
ALTER TABLE `pc_registros`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_servicios`
--
ALTER TABLE `pc_servicios`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_signup`
--
ALTER TABLE `pc_signup`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_slider`
--
ALTER TABLE `pc_slider`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_tareas`
--
ALTER TABLE `pc_tareas`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_temas`
--
ALTER TABLE `pc_temas`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_testimonios`
--
ALTER TABLE `pc_testimonios`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pc_visitas`
--
ALTER TABLE `pc_visitas`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT de la tabla `pc_access`
--
ALTER TABLE `pc_access`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `pc_api_version`
--
ALTER TABLE `pc_api_version`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `pc_blog`
--
ALTER TABLE `pc_blog`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_blog_coment`
--
ALTER TABLE `pc_blog_coment`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_clientes`
--
ALTER TABLE `pc_clientes`
  MODIFY `ID_cli` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `pc_comp`
--
ALTER TABLE `pc_comp`
  MODIFY `ID` int(1) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_config`
--
ALTER TABLE `pc_config`
  MODIFY `ID` int(1) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_contacto`
--
ALTER TABLE `pc_contacto`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `pc_contacto_forms`
--
ALTER TABLE `pc_contacto_forms`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_countries`
--
ALTER TABLE `pc_countries`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251;

--
-- AUTO_INCREMENT de la tabla `pc_css`
--
ALTER TABLE `pc_css`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_css2`
--
ALTER TABLE `pc_css2`
  MODIFY `ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_cursos`
--
ALTER TABLE `pc_cursos`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_cursos_coment`
--
ALTER TABLE `pc_cursos_coment`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_depa`
--
ALTER TABLE `pc_depa`
  MODIFY `ID` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `pc_directorio`
--
ALTER TABLE `pc_directorio`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_empresa`
--
ALTER TABLE `pc_empresa`
  MODIFY `ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `pc_galeria`
--
ALTER TABLE `pc_galeria`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_histo_backupdb`
--
ALTER TABLE `pc_histo_backupdb`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_home_config`
--
ALTER TABLE `pc_home_config`
  MODIFY `ID` int(1) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_iconos`
--
ALTER TABLE `pc_iconos`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `pc_ipbann`
--
ALTER TABLE `pc_ipbann`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `pc_landingpage_seccion`
--
ALTER TABLE `pc_landingpage_seccion`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `pc_map_config`
--
ALTER TABLE `pc_map_config`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `pc_map_ubicacion`
--
ALTER TABLE `pc_map_ubicacion`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_menu_admin`
--
ALTER TABLE `pc_menu_admin`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `pc_menu_web`
--
ALTER TABLE `pc_menu_web`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `pc_mode_page`
--
ALTER TABLE `pc_mode_page`
  MODIFY `ID` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `pc_modulos`
--
ALTER TABLE `pc_modulos`
  MODIFY `ID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `pc_noticias`
--
ALTER TABLE `pc_noticias`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_noticias_coment`
--
ALTER TABLE `pc_noticias_coment`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_notificacion`
--
ALTER TABLE `pc_notificacion`
  MODIFY `ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_opciones`
--
ALTER TABLE `pc_opciones`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT de la tabla `pc_pages`
--
ALTER TABLE `pc_pages`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_portafolio`
--
ALTER TABLE `pc_portafolio`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_productos`
--
ALTER TABLE `pc_productos`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `pc_productos_cate`
--
ALTER TABLE `pc_productos_cate`
  MODIFY `ID_cate` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `pc_productos_coti`
--
ALTER TABLE `pc_productos_coti`
  MODIFY `ID_coti` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_productos_coti_r`
--
ALTER TABLE `pc_productos_coti_r`
  MODIFY `ID_reg` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_productos_files`
--
ALTER TABLE `pc_productos_files`
  MODIFY `ID_pfile` int(9) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_productos_marcas`
--
ALTER TABLE `pc_productos_marcas`
  MODIFY `ID_marca` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `pc_productos_sub_cate`
--
ALTER TABLE `pc_productos_sub_cate`
  MODIFY `ID_sub_cate` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT de la tabla `pc_productos_sub_cate2`
--
ALTER TABLE `pc_productos_sub_cate2`
  MODIFY `ID_sub_cate2` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_promociones`
--
ALTER TABLE `pc_promociones`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `pc_registros`
--
ALTER TABLE `pc_registros`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pc_servicios`
--
ALTER TABLE `pc_servicios`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_signup`
--
ALTER TABLE `pc_signup`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `pc_slider`
--
ALTER TABLE `pc_slider`
  MODIFY `ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_tareas`
--
ALTER TABLE `pc_tareas`
  MODIFY `ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pc_temas`
--
ALTER TABLE `pc_temas`
  MODIFY `ID` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `pc_testimonios`
--
ALTER TABLE `pc_testimonios`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `pc_visitas`
--
ALTER TABLE `pc_visitas`
  MODIFY `ID` int(9) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
