		...
		<div class="box box-primary">
			<div class="box-header with-border">
				...
				<span class="controles">${sel}
					<a href="http://localhost/MisSitios/phponixdev/index.php?mod=servicios&ext=admin/index&form=1&action=edit&id=${task.ID}" title="Editar"><i class="fa fa-edit"></i></a> | <a href="#" taskid="${task.ID}" class="task-delete" title="Borrar"><i class="fa fa-trash"></i></a>
				</span>
			</div>
			<div class="box-body">
				<div class="ima-size">
					<img src="http://localhost/MisSitios/phponixdev/modulos/servicios/fotos/${task.cover}" class="ima-size img-responsive">
				</div>
